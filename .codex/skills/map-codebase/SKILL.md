...
- Use Serena only for read-only source discovery, symbols, references, structure, dependencies, and impact evidence when project trigger rules require it.
- Do not use Serena for planning, task allocation, design decisions, edits, approvals, or workflow execution.
